...
(
    ...
    PRIMARY KEY (id),
    CONSTRAINT check_category CHECK (category IN('frutta', 'verdura', 'cereali', 'legumi', 'carne', 'pesce', 'uova', 'latticini', 'frutta secca e semi', 'grassi', 'dolci e zuccheri', 'bevande')),
